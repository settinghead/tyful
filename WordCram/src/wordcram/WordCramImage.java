...
public class WordCramImage {
	 ...
	 */
	public WordCramImage withStopWords(String extraStopWords) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage excludeNumbers() {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage includeNumbers() {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage lowerCase() {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage upperCase() {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage fromWebPage(String webPageAddress) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage fromHtmlFile(String htmlFilePath) {
	...
	public WordCramImage fromHtmlString(String... html) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage fromTextFile(String textFilePathOrUrl) {
	...
	public WordCramImage fromTextString(String... text) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage fromText(TextSource textSource) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withFonts(String... fontNames) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withFont(String fontName) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withFonts(PFont... fonts) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withFont(PFont font) {
	 ...
	 */
	public WordCramImage withFonter(WordFonter fonter) {
		this.fonter = fonter;
		return this;
	}
	...
	public WordCramImage sizedByWeight(int minSize, int maxSize) {
	...
	public WordCramImage sizedByRank(int minSize, int maxSize) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withSizer(WordSizer sizer) {
		this.sizer = sizer;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withColors(int... colors) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withColor(int color) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withColorer(WordColorer colorer) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage angledAt(float... anglesInRadians) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage angledBetween(float minAngleInRadians,
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withAngler(WordAngler angler) {
		this.angler = angler;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withPlacer(WordPlacer placer) {
		this.placer = placer;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withNudger(WordNudger nudger) {
		this.nudger = nudger;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage maxAttemptsToPlaceWord(int maxAttempts) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage maxNumberOfWordsToDraw(int maxWords) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage minShapeSize(int minShapeSize) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withCustomCanvas(PGraphics canvas) {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public WordCramImage withWordPadding(int padding) {
	...
	public WordCramEngine getWordCramEngine() {
		if (wordCramEngine == null) {
			...
			PGraphics canvas = destination;
			wordCramEngine = new WordCramEngine(canvas, words, img, fonter,
					sizer, colorer, angler, placer, nudger,
					new BBPolarTreeBuilder(), renderOptions);
		}
