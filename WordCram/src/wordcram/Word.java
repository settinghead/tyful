...
public class Word implements Comparable<Word> {
	...
	private PlaceInfo presetTargetPlace;
	...
	private PlaceInfo targetPlaceInfo;
	 ...
	 * @return the Word, for more configuration
	 */
	public Word setFont(PFont font) { // TODO provide a string overload? Will
										// need the PApplet...
	 ...
	 * @return the Word, for more configuration
	 */
	public Word setPlace(PlaceInfo place) {
		this.presetTargetPlace = new PlaceInfo(place.getpVector().get(),
	 ...
	 * @return the Word, for more configuration
	 */
	public Word setPlace(float x, float y, Object returnData) {
		this.presetTargetPlace = new PlaceInfo(new PVector(x, y), returnData);
		return this;
	}
	...
	Float getSize(WordSizer sizer, int rank, int wordCount) {
		renderedSize = presetSize != null ? presetSize : sizer.sizeFor(this,
				rank, wordCount);
		return renderedSize;
	}
	...
	Integer getColor(WordColorer colorer) {
		renderedColor = presetColor != null ? presetColor : colorer
				.colorFor(this);
		return renderedColor;
	}

	PlaceInfo getTargetPlace(WordPlacer placer, int rank, int count,
	 ...
	 */
	public PlaceInfo getTargetPlace() {
		return targetPlaceInfo;
	}
