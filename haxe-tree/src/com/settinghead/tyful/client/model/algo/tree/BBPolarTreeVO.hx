...
class BBPolarTreeVO {
	...
	private var _kids:Vector<BBPolarChildTreeVO>;
	...
	public inline function addKids(kidList:Vector<BBPolarChildTreeVO>):Void {
		_kids = kidList;
	}
	...
	public inline function getKids():Vector<BBPolarChildTreeVO> {
	...
	public inline function getKidsNoGrowth():Vector<BBPolarChildTreeVO> {
		return this._kids;
	}
