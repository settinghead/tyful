Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  fb_permissions = "offline_access, user_about_me, publish_stream, publish_actions, user_notes, user_status, user_activities, user_likes, user_interests, user_hometown, user_location, email, user_checkins"
