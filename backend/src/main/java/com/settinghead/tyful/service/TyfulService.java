...
import com.settinghead.tyful.service.task.Task;

public class TyfulService<T extends Task> {
	...
	public TyfulService(Class<T> taskType) {
	...
	protected static Properties getPropertiesFromClasspath(String propFileName)
		...
		InputStream inputStream = TyfulService.class.getClassLoader()
