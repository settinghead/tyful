...
//        writer.println("    <td>" + clean + "</td>");
  ...
  public void setColumnCount(int newCount) {
    ...
    if (oldCount != newCount) {
      ...
      if (columnTitles != null) {
        columnTitles = (String[]) PApplet.expand(columnTitles, newCount);
      }
      columnTypes = (int[]) PApplet.expand(columnTypes, newCount);
      columnCategories = (HashMapBlows[])
...
//  }
  ...
  public int[] findRows(String what, int column) {
    ...
    return (int[]) PApplet.subset(outgoing, 0, count);
  }
