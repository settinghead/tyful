...
public class PlottingWordPlacer implements WordPlacer {
	...
	private var wrappedPlacer:WordPlacer;
	
	public function PlottingWordPlacer(_parent:PApplet, _wrappedPlacer:WordPlacer) {
		parent = _parent;
	...
	public function place(word:Word, wordIndex:int, wordsCount:int, wordImageWidth:int, wordImageHeight:int, fieldWidth:int, fieldHeight:int):PVector {
		var v:PVector= wrappedPlacer.place(word, wordIndex, wordsCount, wordImageWidth, wordImageHeight, fieldWidth, fieldHeight);
		parent.pushStyle();
		parent.noFill();
