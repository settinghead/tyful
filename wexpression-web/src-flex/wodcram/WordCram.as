...
public class WordCram {
	 ...
	 */
	public function WordCram(parent:PApplet) {
		this.parent = parent;
	}
	 ...
	 */
	public function withStopWords(extraStopWords:String):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function excludeNumbers():WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function includeNumbers():WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function lowerCase():WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function upperCase():WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function keepCase():WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function fromWebPage(webPageAddress:String):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function fromHtmlFile(htmlFilePath:String):WordCram {
	...
	public function fromHtmlString( ... html):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing. 
	 */
	public function fromTextFile(textFilePathOrUrl:String):WordCram {
	...
	public function fromTextString( ... text):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function fromText(textSource:TextSource):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing. 
	 */
	public function fromWords(words:Array):WordCram {
		this.words = words;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withFonts( ... fontNames):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withFont(fontName:String):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withFonts( ... fonts):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withFont(font:PFont):WordCram {
	 ...
	 * example withFonter(new WordFonter() { ... (how to doc-gen this?)
	 =*/
	public function withFonter(fonter:WordFonter):WordCram {
		this.fonter = fonter;
		return this;
	}
	...
	public function sizedByWeight(minSize:int, maxSize:int):WordCram {
	...
	public function sizedByRank(minSize:int, maxSize:int):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withSizer(sizer:WordSizer):WordCram {
		this.sizer = sizer;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withColors( ... colors):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withColor(color:int):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withColorer(colorer:WordColorer):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function angledAt( ... anglesInRadians):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function angledBetween(minAngleInRadians:Number, maxAngleInRadians:Number):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withAngler(angler:WordAngler):WordCram {
		this.angler = angler;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withPlacer(placer:WordPlacer):WordCram {
		this.placer = placer;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withNudger(nudger:WordNudger):WordCram {
		this.nudger = nudger;
		return this;
	}
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function maxAttemptsToPlaceWord(maxAttempts:int):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function maxNumberOfWordsToDraw(maxWords:int):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function minShapeSize(minShapeSize:int):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withCustomCanvas(canvas:PGraphics):WordCram {
	 ...
	 * @return The WordCram, for further setup or drawing.
	 */
	public function withWordPadding(padding:int):WordCram {
		renderOptions.wordPadding = padding;
		return this;
	}
	
	
	private function getWordCramEngine():WordCramEngine {
		if (wordCramEngine == null) {
			...
			var canvas:PGraphics= destination == null? parent.g : destination; 
