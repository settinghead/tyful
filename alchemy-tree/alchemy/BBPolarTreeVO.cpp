...
const double BBPolarTreeVO::HALF_PI = 1.57079633;
const double BBPolarTreeVO::TWO_PI = 1.57079633;
const double BBPolarTreeVO::ONE_AND_HALF_PI = 1.57079633;
const double BBPolarTreeVO::MARGIN = 0;
...
BBPolarTreeVO::BBPolarTreeVO(double r1, double r2, double d1, double d2,
	...
	double r = (r2 - r1);
	double d = (double(((BBPolarTreeVO::PI * ((d1 + d2))) * r))
			/ double(BBPolarTreeVO::TWO_PI));
...
void BBPolarTreeVO::computeR1() {
	{
		...
		if (((this->_computedR1 > BBPolarTreeVO::TWO_PI))) {
			this->_computedR1 = fmod(this->_computedR1, BBPolarTreeVO::TWO_PI);
		}
	}
}
...
void BBPolarTreeVO::computeR2() {
	{
		...
		if (((this->_computedR2 > BBPolarTreeVO::TWO_PI))) {
			this->_computedR2 = fmod(this->_computedR2, BBPolarTreeVO::TWO_PI);
		}
	}
}
...
double BBPolarTreeVO::getX(bool rotate) {
	if ((rotate)) {
		this->checkComputeX();
		return (this->_x - BBPolarTreeVO::MARGIN);
	} else {
...
double BBPolarTreeVO::getY(bool rotate) {
	if ((rotate)) {
		this->checkComputeY();
		return (this->_y - BBPolarTreeVO::MARGIN);
	} else {
...
double BBPolarTreeVO::getRight(bool rotate) {
	if ((rotate)) {
		...
		return (this->_right + BBPolarTreeVO::MARGIN);
	} else {
...
double BBPolarTreeVO::getBottom(bool rotate) {
	if ((rotate)) {
		...
		return (this->_bottom + BBPolarTreeVO::MARGIN);
	}
