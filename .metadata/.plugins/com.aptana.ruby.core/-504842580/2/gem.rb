module Gem
  ...
  ConfigMap = {:EXEEXT=>"", :RUBY_SO_NAME=>"ruby.1.9.1", :arch=>"x86_64-darwin11.2.0", :bindir=>"/usr/local/Cellar/ruby/1.9.2-p180/bin", :libdir=>"/usr/local/Cellar/ruby/1.9.2-p180/lib", :ruby_install_name=>"ruby", :ruby_version=>"1.9.1", :rubylibprefix=>"/usr/local/Cellar/ruby/1.9.2-p180/lib/ruby", :sitedir=>"/usr/local/Cellar/ruby/1.9.2-p180/lib/ruby/site_ruby", :sitelibdir=>"/usr/local/Cellar/ruby/1.9.2-p180/lib/ruby/site_ruby/1.9.1"}
